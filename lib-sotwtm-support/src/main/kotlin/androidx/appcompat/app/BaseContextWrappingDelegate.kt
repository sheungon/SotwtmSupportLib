...
/**
 * androidx.appcompat:appcompat:1.2.0 locale fix
 * @see <a href="https://stackoverflow.com/a/58004553">Ref</a>
 * */
class BaseContextWrappingDelegate(private val superDelegate: AppCompatDelegate) :
    ...
    private fun wrap(context: Context): Context =
        context.setAppLocale(requireNotNull(SotwtmSupportLib.getInstance().appLocale.get()))
}