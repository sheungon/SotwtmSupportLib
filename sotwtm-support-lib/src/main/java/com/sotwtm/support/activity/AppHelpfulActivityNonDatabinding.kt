 ...
 * This activity without binding with Android Databinding
 * Created by John on 10/11/2015.
 *
 * @author John
 */
abstract class AppHelpfulActivityNonDatabinding
    ...
    fun showSnackBar(message: String,
        ...
        runOnUiThread {
            ...
            val activity = this@AppHelpfulActivityNonDatabinding
    ...
    // Class and interface
    ///////////////////////////////
    private class MyOnBackStackChangedListener internal constructor(activity: AppHelpfulActivityNonDatabinding) : FragmentManager.OnBackStackChangedListener {

        private val activityRef: WeakReference<AppHelpfulActivityNonDatabinding> = WeakReference(activity)
    ...
    private class MyOnSystemUiVisibilityChangeListener internal constructor(activity: AppHelpfulActivityNonDatabinding) : View.OnSystemUiVisibilityChangeListener {

        internal val activityRef: WeakReference<AppHelpfulActivityNonDatabinding> = WeakReference(activity)
